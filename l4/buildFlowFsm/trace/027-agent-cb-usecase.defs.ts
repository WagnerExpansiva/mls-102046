{
  "savedAt": "2026-08-18T12:32:17.161Z",
  ...
  "payload": {
    ...
    "result": {
      ...
      "arguments": {
        ...
        "questions": [],
        "trace": [
          "Public inputs include only selectedEntity and userInput sources: timeLogId, workTaskId, workDate, hoursWorked, and hourlyLaborCost.",
          "status is resolved from systemDefault and fieldWorkerId from actorSession; neither is exposed as client input.",
          "The TimeLog is the parent aggregate, so mutation uses the TimeLog port directly; no child repository is introduced."
        ]
      }
    },
    "status": "completed",
