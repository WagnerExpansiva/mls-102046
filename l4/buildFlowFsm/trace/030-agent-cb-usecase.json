{
  "savedAt": "2026-08-18T12:30:29.187Z",
  ...
  "payload": {
    ...
    "result": {
      ...
      "arguments": {
        ...
        "questions": [],
        "trace": [
          "The selectedEntity inventoryItemId and userInput fields are public inputs.",
          "The systemDefault status is resolved server-side and is excluded from the public input contract.",
          "No MDM references or child aggregate handling apply.",
