/// <mls fileReference="_{project}_/l4/buildFlowFsm/contracts/assignWorkTask.qryLocateProject.defs.ts" enhancement="_blank"/>

// GENERATED MECHANICALLY from l4/buildFlowFsm/workspaces/assignWorkTask.defs.ts — DO NOT EDIT.
// Contract of record: bffCall qryLocateProject (query); Output kind=list; route buildFlowFsm.assignWorkTask.qryLocateProject.
