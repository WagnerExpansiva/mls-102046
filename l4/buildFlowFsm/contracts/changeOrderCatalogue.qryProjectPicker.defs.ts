/// <mls fileReference="_{project}_/l4/buildFlowFsm/contracts/changeOrderCatalogue.qryProjectPicker.defs.ts" enhancement="_blank"/>

// GENERATED MECHANICALLY from l4/buildFlowFsm/workspaces/changeOrderCatalogue.defs.ts — DO NOT EDIT.
// Contract of record: bffCall qryProjectPicker (query); Output kind=list; route buildFlowFsm.changeOrderCatalogue.qryProjectPicker.
