/// <mls fileReference="_{project}_/l4/buildFlowFsm/contracts/consultClientProjectUpdates.qryLocateProject.defs.ts" enhancement="_blank"/>

// GENERATED MECHANICALLY from l4/buildFlowFsm/workspaces/consultClientProjectUpdates.defs.ts — DO NOT EDIT.
// Contract of record: bffCall qryLocateProject (query); Output kind=list; route buildFlowFsm.consultClientProjectUpdates.qryLocateProject.
