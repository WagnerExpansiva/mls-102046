/// <mls fileReference="_102046_/l2/buildFlowFsm/web/desktop/page11/assignWorkTask.test.ts" enhancement="_blank"/>
  ...
  "cases": [
    {
      ...
      "routine": "buildFlowFsm.assignWorkTask.qryLocateProject",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
    ...
    {
      "id": "qryLocateFieldWorker.ok",
      "routine": "buildFlowFsm.assignWorkTask.qryLocateFieldWorker",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
