/// <mls fileReference="_102046_/l2/buildFlowFsm/web/desktop/page11/recordProjectMaterialUsage.test.ts" enhancement="_blank"/>
...
export const pageTests = {
  ...
  "page": "recordProjectMaterialUsage",
  "variant": "page11",
  "actor": "fieldWorker",
  "cases": [
    {
      "id": "qryLocateProject.ok",
      "routine": "buildFlowFsm.recordProjectMaterialUsage.qryLocateProject",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
    ...
    {
      "id": "qryLocateInventoryItem.ok",
      "routine": "buildFlowFsm.recordProjectMaterialUsage.qryLocateInventoryItem",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
    ...
    },
    {
      ...
      "routine": "buildFlowFsm.recordProjectMaterialUsage.qryInventoryBalancePicker",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
