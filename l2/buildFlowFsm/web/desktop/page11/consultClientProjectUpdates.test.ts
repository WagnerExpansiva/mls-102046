/// <mls fileReference="_102046_/l2/buildFlowFsm/web/desktop/page11/consultClientProjectUpdates.test.ts" enhancement="_blank"/>
...
export const pageTests = {
  ...
  "page": "consultClientProjectUpdates",
  "variant": "page11",
  "actor": "client",
  "cases": [
    {
      "id": "qryLocateProject.ok",
      "routine": "buildFlowFsm.consultClientProjectUpdates.qryLocateProject",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
