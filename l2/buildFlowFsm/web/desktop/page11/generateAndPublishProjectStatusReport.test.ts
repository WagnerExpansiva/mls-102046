/// <mls fileReference="_102046_/l2/buildFlowFsm/web/desktop/page11/generateAndPublishProjectStatusReport.test.ts" enhancement="_blank"/>
...
export const pageTests = {
  ...
  "page": "generateAndPublishProjectStatusReport",
  "variant": "page11",
  "actor": "projectManager",
  "cases": [
    {
      "id": "qryLocateProject.ok",
      "routine": "buildFlowFsm.generateAndPublishProjectStatusReport.qryLocateProject",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
