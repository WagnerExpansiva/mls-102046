/// <mls fileReference="_102046_/l2/buildFlowFsm/web/desktop/page11/declineChangeOrder.test.ts" enhancement="_blank"/>
...
export const pageTests = {
  ...
  "page": "declineChangeOrder",
  "variant": "page11",
  "actor": "projectManager",
  "cases": [
    {
      "id": "qryLocateChangeOrder.ok",
      "routine": "buildFlowFsm.declineChangeOrder.qryLocateChangeOrder",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
    ...
    },
    {
      ...
      "routine": "buildFlowFsm.declineChangeOrder.qryClientPicker",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
