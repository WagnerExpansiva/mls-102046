/// <mls fileReference="_102046_/l2/buildFlowFsm/web/desktop/page11/monitorDailyProjectRecords.test.ts" enhancement="_blank"/>
...
export const pageTests = {
  ...
  "page": "monitorDailyProjectRecords",
  "variant": "page11",
  "actor": "fieldCoordinator",
  "cases": [
    {
      "id": "qryLocateProject.ok",
      "routine": "buildFlowFsm.monitorDailyProjectRecords.qryLocateProject",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
