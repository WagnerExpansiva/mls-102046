/// <mls fileReference="_102046_/l2/buildFlowFsm/web/desktop/page11/projectDashboardView.test.ts" enhancement="_blank"/>
  ...
  "cases": [
    {
      ...
      "routine": "buildFlowFsm.projectDashboardView.qryProjectDashboardView",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "object"
