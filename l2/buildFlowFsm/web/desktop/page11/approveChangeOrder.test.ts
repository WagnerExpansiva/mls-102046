/// <mls fileReference="_102046_/l2/buildFlowFsm/web/desktop/page11/approveChangeOrder.test.ts" enhancement="_blank"/>
...
export const pageTests = {
  ...
  "page": "approveChangeOrder",
  "variant": "page11",
  "actor": "client",
  "cases": [
    {
      "id": "qryLocateChangeOrder.ok",
      "routine": "buildFlowFsm.approveChangeOrder.qryLocateChangeOrder",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
    ...
    },
    {
      ...
      "routine": "buildFlowFsm.approveChangeOrder.qryClientPicker",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
