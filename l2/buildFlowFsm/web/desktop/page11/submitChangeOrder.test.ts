/// <mls fileReference="_102046_/l2/buildFlowFsm/web/desktop/page11/submitChangeOrder.test.ts" enhancement="_blank"/>
...
export const pageTests = {
  ...
  "page": "submitChangeOrder",
  "variant": "page11",
  "actor": "fieldCoordinator",
  "cases": [
    {
      "id": "qryLocateClient.ok",
      "routine": "buildFlowFsm.submitChangeOrder.qryLocateClient",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
    ...
    },
    {
      ...
      "routine": "buildFlowFsm.submitChangeOrder.qryLocateProject",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
