/// <mls fileReference="_102046_/l2/buildFlowFsm/web/desktop/page11/forwardChangeOrderForClientApproval.test.ts" enhancement="_blank"/>
...
export const pageTests = {
  ...
  "page": "forwardChangeOrderForClientApproval",
  "variant": "page11",
  "actor": "projectManager",
  "cases": [
    {
      "id": "qryLocateChangeOrder.ok",
      "routine": "buildFlowFsm.forwardChangeOrderForClientApproval.qryLocateChangeOrder",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
