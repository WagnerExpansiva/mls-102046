/// <mls fileReference="_102046_/l2/buildFlowFsm/web/desktop/page11/workTaskCatalogue.test.ts" enhancement="_blank"/>
...
export const pageTests = {
  ...
  "page": "workTaskCatalogue",
  "variant": "page11",
  "actor": "fieldCoordinator",
  "cases": [
    {
      "id": "qryListWorkTask.ok",
      "routine": "buildFlowFsm.workTaskCatalogue.qryListWorkTask",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
    ...
    {
      "id": "cmdDeleteWorkTask.ok",
      "routine": "buildFlowFsm.workTaskCatalogue.cmdDeleteWorkTask",
      "params": {
        "workTaskId": "<seedRef>"
      },
      "expect": {
