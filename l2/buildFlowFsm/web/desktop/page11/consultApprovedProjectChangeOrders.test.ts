/// <mls fileReference="_102046_/l2/buildFlowFsm/web/desktop/page11/consultApprovedProjectChangeOrders.test.ts" enhancement="_blank"/>
...
export const pageTests = {
  ...
  "page": "consultApprovedProjectChangeOrders",
  "variant": "page11",
  "actor": "client",
  "cases": [
    {
      "id": "qryLocateProject.ok",
      "routine": "buildFlowFsm.consultApprovedProjectChangeOrders.qryLocateProject",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
