/// <mls fileReference="_102046_/l2/buildFlowFsm/web/desktop/page11/recordWorkTime.test.ts" enhancement="_blank"/>
  ...
  "cases": [
    {
      ...
      "routine": "buildFlowFsm.recordWorkTime.qryLocateFieldWorker",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
    ...
    },
    {
      ...
      "routine": "buildFlowFsm.recordWorkTime.qryLocateWorkTask",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
