/// <mls fileReference="_102046_/l2/buildFlowFsm/web/desktop/page11/updateWorkTaskProgress.test.ts" enhancement="_blank"/>
...
export const pageTests = {
  ...
  "page": "updateWorkTaskProgress",
  "variant": "page11",
  "actor": "fieldWorker",
  "cases": [
    {
      "id": "qryLocateWorkTask.ok",
      "routine": "buildFlowFsm.updateWorkTaskProgress.qryLocateWorkTask",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
