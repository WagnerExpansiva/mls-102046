/// <mls fileReference="_102046_/l2/buildFlowFsm/web/desktop/page11/reviewProjectPortfolio.test.ts" enhancement="_blank"/>
...
export const pageTests = {
  ...
  "page": "reviewProjectPortfolio",
  "variant": "page11",
  "actor": "projectManager",
  "cases": [
    {
      "id": "qryInspectProjectDashboard.ok",
      "routine": "buildFlowFsm.reviewProjectPortfolio.qryInspectProjectDashboard",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "object"
    ...
    },
    {
      ...
      "routine": "buildFlowFsm.reviewProjectPortfolio.qryLocateProject",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
