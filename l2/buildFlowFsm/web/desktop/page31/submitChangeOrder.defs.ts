/// <mls fileReference="_102046_/l2/buildFlowFsm/web/desktop/page31/submitChangeOrder.defs.ts" enhancement="_blank"/>
...
export const definition = {
  ...
  "pageObjective": {
    "actor": "Responsável por formalizar alterações de uma obra e encaminhá-las ao gerente de projeto.",
    "jobToBeDone": "Selecionar o cliente e a obra corretos, registrar os impactos da alteração e submetê-la ao gerente de projeto para tratamento.",
    "primaryDecision": "Submeter a ordem de mudança correta ao gerente de projeto após conferir seu contexto e impactos.",
    "decisiveInfo": [
      "clientName",
      "projectId",
      "name",
    ...
    "usageFrequency": "Ocasional, durante a identificação de uma necessidade de mudança em uma obra; pode ser usado repetidamente em períodos de alterações.",
    "informationHierarchy": [
      "obra e cliente selecionados",
      "estado e identidade da ordem de mudança",
      "descrição da alteração",
      "impacto no escopo",
      "impacto no cronograma",
      "valor da mudança",
      "ação de submissão e feedback do resultado"
    ],
    "successCriteria": "O usuário consegue reconhecer a obra correta, registrar somente os impactos necessários, distinguir uma ordem recém-registrada de uma já submetida e encaminhá-la sem digitar identificadores ou editar estados manualmente.",
    "antiPatterns": [
      "formulário separado para a transição",
      "campo de texto para ids de cliente, obra ou ordem de mudança",
      "select livre de status com todos os estados do ciclo de vida",
      "duplicar desnecessariamente a coleta de dados entre registro e submissão",
      "ocultar o estado atual antes da ação de submissão"
    ],
    "criticalActions": [
      {
        "action": "Registrar a alteração proposta",
        "presentation": "primary-button com contexto de cliente e obra selecionados e resumo dos impactos antes do envio"
      },
      {
        "action": "Submeter a alteração para tratamento",
        "presentation": "contextual-transition-actions junto à ordem selecionada, mostrando o estado atual e somente a próxima ação válida"
      }
    ]
  },
  "dataBindings": [
...
export const pipeline = [
  {
    "id": "submitChangeOrder__page31__l2_page",
    "type": "l2_page",
    "outputPath": "_102046_/l2/buildFlowFsm/web/desktop/page31/submitChangeOrder.ts",
    "defPath": "_102046_/l2/buildFlowFsm/web/desktop/page31/submitChangeOrder.defs.ts",
    "dependsFiles": [
